...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white border border-gray-200 p-5 rounded-sm">
            <p class="text-xs uppercase tracking-wider text-gray-500 font-medium">Total Buku</p>
            <h3 class="text-3xl font-light text-gray-900 mt-2">{{ $totalBooks }}</h3>
            <p class="text-xs text-gray-400 mt-2">Eksemplar</p>
        </div>

        <div class="bg-white border border-gray-200 p-5 rounded-sm">
            <p class="text-xs uppercase tracking-wider text-gray-500 font-medium">Total Anggota</p>
    ...
    <div class="bg-white border border-gray-200 rounded-sm">
        <div class="px-5 py-4 border-b border-gray-200">
            <h3 class="text-sm font-medium text-gray-900">Aktivitas Transaksi Terbaru</h3>
        </div>
        <div class="p-5">
                ...
                <table class="w-full text-sm text-left">
                    <thead class="text-xs text-gray-500 uppercase border-b border-gray-200">
                        <tr>
                            ...
                            <th class="py-3 px-2 font-medium">Petugas</th>
